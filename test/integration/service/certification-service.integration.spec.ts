...
describe("CertificationService Integration Tests", () => {
    ...
    describe("createCertificationEntity", () => {
        ...
        describe("TOEFL CBT Certifications", () => {
            it("should create TOEFL CBT certification with valid score", () => {
                ...
                expect(result.examType).toBe(CCNNType.TOEFL_CBT);
        ...
        describe("TOEFL iBT Certifications", () => {
            it("should create TOEFL iBT certification with valid score", () => {
                ...
                expect(result.examType).toBe(CCNNType.TOEFL_iBT);
        ...
        describe("TOEFL Paper Certifications", () => {
            it("should create TOEFL Paper certification with valid score", () => {
                ...
                expect(result.examType).toBe(CCNNType.TOEFL_Paper);
        ...
        describe("TOEIC Certifications", () => {
            it("should create TOEIC certification with valid score", () => {
                ...
                expect(result.examType).toBe(CCNNType.TOEIC);
        ...
        describe("JLPT Certifications", () => {
            it("should create JLPT certification with valid level", () => {
                ...
                expect(result.examType).toBe(CCNNType.JLPT);
        ...
        describe("Non-CCNN Exam Types", () => {
            it("should create SAT certification without CEFR mapping", () => {
                ...
                expect(result.examType).toBe(CCQTType.SAT);
            ...
            it("should create ACT certification without CEFR mapping", () => {
                ...
                expect(result.examType).toBe(CCQTType.ACT);
            ...
            it("should create IB certification without CEFR mapping", () => {
                ...
                expect(result.examType).toBe(CCQTType.IB);
            ...
            it("should create A_Level certification without CEFR mapping", () => {
                ...
                expect(result.examType).toBe(CCQTType.A_Level);
    ...
    describe("createCertificationEntities", () => {
        it("should create multiple certification entities", () => {
            ...
            const certRequests: CertificationRequest[] = [
                ...
                { examType: CCNNType.JLPT, level: "N2" },
            ];
            ...
            expect(results[1].examType).toBe(CCNNType.TOEIC);
            expect(results[1].cefr).toBe(CEFR.B2);
            expect(results[2].examType).toBe(CCNNType.JLPT);
        ...
        it("should create entities with different CEFR levels", () => {
            const certRequests: CertificationRequest[] = [
                { examType: CCNNType.IELTS, level: "3.5" }, // A2
                { examType: CCNNType.IELTS, level: "5.0" }, // B1
                { examType: CCNNType.IELTS, level: "6.5" }, // B2
                { examType: CCNNType.IELTS, level: "7.5" }, // C1
                { examType: CCNNType.IELTS, level: "8.5" }, // C2
            ];
        ...
        it("should throw ValidationException if any certification is invalid", () => {
            const certRequests: CertificationRequest[] = [
                { examType: CCNNType.IELTS, level: "7.5" },
                { examType: CCNNType.IELTS, level: "10.0" }, // Invalid
            ];
    ...
    describe("getCEFRLevel", () => {
        it("should return undefined for non-CCNN exam types", () => {
            ...
            expect(
                certificationService.getCEFRLevel(CCQTType.A_Level, "A*"),
            ).toBeUndefined();
        });

        it("should return undefined for JLPT (CCNN type but no CEFR mapping)", () => {
            expect(
                certificationService.getCEFRLevel(CCNNType.JLPT, "N2"),
            ).toBeUndefined();
            expect(
        ...
        it("should return undefined for invalid numeric levels", () => {
            expect(
                certificationService.getCEFRLevel(CCNNType.IELTS, "invalid"),
            ).toBeUndefined();
            expect(
                certificationService.getCEFRLevel(CCNNType.TOEIC, "abc"),
            ).toBeUndefined();
        });
        ...
        it("should return undefined for out of range scores", () => {
            ...
            expect(
                certificationService.getCEFRLevel(CCNNType.TOEIC, "50"),
            ).toBeUndefined();
            expect(
                certificationService.getCEFRLevel(CCNNType.TOEIC, "1000"),
            ).toBeUndefined();
        });
    ...
    describe("Type Guard Tests", () => {
        it("should correctly identify CCNN types", () => {
            ...
            expect(isCCNNType(CCQTType.IB)).toBe(false);
        });
    ...
    describe("Complex Scenarios", () => {
        it("should handle mixed certification types in batch creation", () => {
            const certRequests: CertificationRequest[] = [
                { examType: CCNNType.IELTS, level: "7.5" }, // CCNN with CEFR
                { examType: CCNNType.JLPT, level: "N2" }, // CCNN without CEFR
                { examType: CCQTType.SAT, level: "1400" }, // CCQT
                { examType: CCQTType.A_Level, level: "A*" }, // CCQT string
            ];
        ...
        it("should handle all CEFR levels across different exam types", () => {
            const certRequests: CertificationRequest[] = [
                { examType: CCNNType.IELTS, level: "3.0" }, // A1
                { examType: CCNNType.TOEIC, level: "300" }, // A2
                { examType: CCNNType.TOEFL_iBT, level: "45" }, // B1
                { examType: CCNNType.TOEFL_CBT, level: "195" }, // B2
                { examType: CCNNType.TOEFL_Paper, level: "530" }, // C1
                { examType: CCNNType.IELTS, level: "9.0" }, // C2
            ];
        ...
        describe("Negative Score Validation Across Exam Types", () => {
            it("should reject negative scores for all numeric exam types", () => {
                const negativeScoreTests: {
                    ...
                    { examType: CCNNType.IELTS, level: "-1.0" },
                    { examType: CCNNType.TOEFL_iBT, level: "-1" },
                    { examType: CCNNType.TOEFL_CBT, level: "-50" },
                    { examType: CCNNType.TOEFL_Paper, level: "-100" },
                    { examType: CCNNType.TOEIC, level: "-5" },
                    { examType: CCQTType.SAT, level: "-100" },
                    { examType: CCQTType.ACT, level: "-5" },
                    { examType: CCQTType.IB, level: "-10" },
                ];
        ...
        describe("CCNN Exam Type Minimum Score CEFR Mapping", () => {
            it("should correctly map absolute minimum scores to CEFR A1", () => {
                const minScores: {
                    ...
                    { cefr: CEFR.A1, examType: CCNNType.IELTS, level: "1.0" },
                    { cefr: CEFR.A1, examType: CCNNType.TOEFL_iBT, level: "0" },
                    {
                        cefr: CEFR.A1,
                        examType: CCNNType.TOEFL_CBT,
                        level: "33",
                    ...
                    { cefr: CEFR.A1, examType: CCNNType.TOEIC, level: "60" },
                ];
        ...
        describe("Edge Cases for All Exam Types", () => {
            it("should handle minimum valid scores that result in A1 CEFR across exam types", () => {
                const minA1Scores: {
                    ...
                    { examType: CCNNType.IELTS, level: "1.0" },
                    { examType: CCNNType.IELTS, level: "1.5" },
                    { examType: CCNNType.TOEFL_iBT, level: "0" },
                    { examType: CCNNType.TOEFL_iBT, level: "3" },
                    { examType: CCNNType.TOEFL_CBT, level: "33" },
                    { examType: CCNNType.TOEFL_CBT, level: "45" },
                    { examType: CCNNType.TOEFL_Paper, level: "310" },
                    { examType: CCNNType.TOEFL_Paper, level: "330" },
                    { examType: CCNNType.TOEIC, level: "60" },
                    { examType: CCNNType.TOEIC, level: "100" },
                ];
            ...
            it("should handle maximum valid scores that result in C2 CEFR across exam types", () => {
                const maxC2Scores: {
                    ...
                    { examType: CCNNType.IELTS, level: "8.5" },
                    { examType: CCNNType.IELTS, level: "9.0" },
                    { examType: CCNNType.TOEFL_iBT, level: "114" },
                    { examType: CCNNType.TOEFL_iBT, level: "120" },
                    { examType: CCNNType.TOEFL_CBT, level: "270" },
                    { examType: CCNNType.TOEFL_CBT, level: "300" },
                    { examType: CCNNType.TOEFL_Paper, level: "600" },
                    { examType: CCNNType.TOEFL_Paper, level: "677" },
                    { examType: CCNNType.TOEIC, level: "985" },
                    { examType: CCNNType.TOEIC, level: "990" },
                ];
    ...
    describe("CCQT Exam Types Validation", () => {
        ...
        it("should validate Duolingo English Test score range", () => {
            ...
            expect(() =>
                certificationService.createCertificationEntity({
                    examType: CCQTType.Duolingo_English_Test,
                    level: "9",
                }),
            ).toThrow(ValidationException);
        ...
        it("should validate PTE Academic score range", () => {
            ...
            expect(() =>
                certificationService.createCertificationEntity({
                    examType: CCQTType.PTE_Academic,
                    level: "9",
                }),
            ).toThrow(ValidationException);
    ...
    describe("Batch Operations Extended", () => {
        it("should handle very large batch (100+ certifications)", () => {
            const largeBatch: {
                ...
                examType: i % 2 === 0 ? CCNNType.IELTS : CCNNType.TOEIC,
                level: i % 2 === 0 ? "7.0" : "850",
            }));
    ...
    describe("DTO Validation with class-validator", () => {
        describe("Valid Certifications", () => {
            it("should validate IELTS certification DTO successfully", async () => {
                ...
                expect(dto.examType).toBe(CCNNType.IELTS);
        ...
        describe("Integration - DTO Validation with Service", () => {
            it("should successfully create entity after DTO validation", async () => {
                ...
                expect(entity.examType).toBe(CCNNType.IELTS);
            ...
            it("should fail validation for boundary invalid scores", async () => {
                const invalidCases = [
                    { examType: CCNNType.IELTS, level: "0.5" },
                    { examType: CCNNType.IELTS, level: "9.5" },
                    { examType: CCNNType.TOEIC, level: "55" },
                    { examType: CCNNType.TOEIC, level: "995" },
                ];
