...
export class AdmissionEntity {
    ...
    @Column({ name: "admission_type", nullable: true, type: "varchar" })
    admissionType?: string;

    @Column({ name: "admission_type_name", nullable: true, type: "varchar" })
    ...
    @Column({ name: "study_program", nullable: true, type: "varchar" })
    studyProgram?: string;

    @Column({ name: "subject_combination", nullable: true, type: "varchar" })
    subjectCombination?: string;

    @Column({ name: "tuition_fee", nullable: true, type: "bigint" })
    tuitionFee?: number;

    @Column({ name: "uni_code", nullable: true, type: "varchar" })
    uniCode?: string;

    @Column({ name: "uni_name", nullable: true, type: "varchar" })
    uniName?: string;

    @Column({ name: "uni_type", nullable: true, type: "varchar" })
    uniType?: string;

    @Column({ name: "uni_web_link", nullable: true, type: "varchar" })
    uniWebLink?: string;
