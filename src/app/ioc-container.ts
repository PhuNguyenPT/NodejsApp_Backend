...
// Prevent multiple container initialization
declare global {
    var __IOC_CONTAINER__: Container | undefined;
    var __IOC_INITIALIZED__: boolean | undefined;
    var __IOC_INIT_PROMISE__: Promise<void> | undefined;
}

// Lock 1: Container singleton
const iocContainer = global.__IOC_CONTAINER__ ?? new Container();
global.__IOC_CONTAINER__ ??= iocContainer;

// Lock 2: Initialization completion
global.__IOC_INIT_PROMISE__ ??= Promise.resolve().then(() => {
    if (!global.__IOC_INITIALIZED__) {
        global.__IOC_INITIALIZED__ = true;
        ...
        iocContainer
            .bind<PredictionModelServiceConfig>(
                TYPES.PredictionModelServiceConfig,
            )
        ...
        iocContainer
            .bind<Options>(TYPES.MulterOptions)
            .toConstantValue(mutterOptions);
        ...
        iocContainer
            ...
            .toConstantValue(
                postgresDataSource.getRepository(AptitudeExamEntity),
            );
        iocContainer
            .bind<
        ...
        iocContainer
            .bind<
                Repository<CertificationEntity>
            >(TYPES.CertificationRepository)
            .toConstantValue(
                postgresDataSource.getRepository(CertificationEntity),
            );
        iocContainer
        ...
        iocContainer
            ...
            .toConstantValue(
                postgresDataSource.getRepository(MajorGroupEntity),
            );
        iocContainer
            .bind<
            ...
            .toConstantValue(
                postgresDataSource.getRepository(StudentMajorGroupEntity),
            );
        iocContainer
        ...
        iocContainer
            ...
            .toConstantValue(
                postgresDataSource.getRepository(NationalExamEntity),
            );
        iocContainer
            .bind<Repository<TalentExamEntity>>(TYPES.TalentExamRepository)
            .toConstantValue(
                postgresDataSource.getRepository(TalentExamEntity),
            );
        iocContainer
        ...
        iocContainer
            ...
            .toConstantValue(
                postgresDataSource.getRepository(TranscriptSubjectEntity),
            );
        iocContainer
            .bind<Repository<TranscriptEntity>>(TYPES.TranscriptRepository)
            .toConstantValue(
                postgresDataSource.getRepository(TranscriptEntity),
            );
        iocContainer
            .bind<
        ...
        iocContainer
            ...
            .inSingletonScope();
        iocContainer
            .bind<IPredictionL3ProcessorService>(
                TYPES.IPredictionL3ProcessorService,
            )
        ...
        iocContainer
            ...
            .inRequestScope();
        iocContainer
            .bind<FileController>(FileController)
            .toSelf()
            .inRequestScope();
        iocContainer
            .bind<OcrController>(OcrController)
            .toSelf()
            .inRequestScope();
        iocContainer
...
await global.__IOC_INIT_PROMISE__;
