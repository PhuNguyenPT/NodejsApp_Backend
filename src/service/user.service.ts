...
export class UsersService {
  ...
  public async create(createUserDto: CreateUserDto): Promise<User> {
    try {
      ...
      logger.info("User created successfully", { userId: savedEntity.id });
      return user;
    } catch (error) {
  ...
  public async exists(id: string): Promise<boolean> {
    try {
      ...
      logger.info("User existence check completed", { exists, userId: id });
      return exists;
    } catch (error) {
      logger.error("Error checking user existence", { error, userId: id });
  ...
  public async update(
    ...
    try {
      ...
      logger.error("Error updating user", { error, updateData, userId: id });
