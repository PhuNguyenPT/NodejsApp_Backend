...
export const TYPES = {
    ...
    PredictModelServer: Symbol.for("PredictModelServer"),
    PredictModelServerConfig: Symbol.for("PredictModelServerConfig"),
    PredictModelService: Symbol.for("PredictModelService"),
    PredictModelServiceConfig: Symbol.for("PredictModelServiceConfig"),
